...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Read all posts in the "${category.name}" category`,
  };
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        {posts.length > 0 ? (
          <>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center gap-2">
                {pageNum > 1 && (
                  <Link
                    href={`/blog/category/${slug}?page=${pageNum - 1}`}
          ...
          <p className="text-center text-gray-600 py-12">No posts found in this category.</p>
        )}
      </div>
    </div>
  );
